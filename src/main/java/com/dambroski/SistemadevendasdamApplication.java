...
public class SistemaDeVendasDamApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente("Maria Silva", "nelio.cursos@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		
		Cliente cli2 = new Cliente("Ana Costa", "nelio.iftm@gmail.com", "31628382740", TipoCliente.PESSOAJURIDICA);
